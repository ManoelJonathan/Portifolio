  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="-mt-15 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[20rem] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-75 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[20rem]  rounded-full bg-neutral-500 opacity-35 blur-3xl"></div>
        <motion.div
          initial={{ width: "15rem" }}
          whileInView={{ width: "var(--line-width)" }}
          transition={{
            delay: 0.5,
            duration: 1.5,
            ease: "easeInOut",
          }}
          className="absolute inset-auto z-50 h-0.5 w-[var(--line-width)] -translate-y-[8rem] md:-translate-y-[6.3rem] bg-gradient-to-r from-transparent via-primary to-transparent [--line-width:28rem] md:[--line-width:60rem]"
        ></motion.div>
